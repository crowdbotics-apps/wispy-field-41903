"""
Django settings for wispy_field_41903 project.
...
ROOT_URLCONF = 'wispy_field_41903.urls'
...
WSGI_APPLICATION = 'wispy_field_41903.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "wispy_field_41903 API",
    "DESCRIPTION": "API documentation for wispy_field_41903 App",
    "VERSION": "v1",
}
